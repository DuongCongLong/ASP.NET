...
namespace ASP.NET.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            objHomeModel.ListProduct = objWebsiteASP_NETEntities.Products.ToList();
            objHomeModel.ListCategory = objWebsiteASP_NETEntities.Categories.ToList();
        ...
        public ActionResult Register(User _user)
        {
            ...
            {
                var check = objWebsiteASP_NETEntities.Users.FirstOrDefault(s => s.Email == _user.Email);
                if (check == null)
                {
                    _user.Password = GetMD5(_user.Password);
                    objWebsiteASP_NETEntities.Configuration.ValidateOnSaveEnabled = false;
                    objWebsiteASP_NETEntities.Users.Add(_user);
